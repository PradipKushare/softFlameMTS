...
class MainTestPageHeader extends Component {
  render() {   
        var default_user = '';
            ...
            <div className="container_header">
                <div className="logo d-flex align-items-center">
                   <strong className="logo_icon">
                     <img src={MTSlogo} alt="" style={{width: '80%'}} /> 
                   </strong>
                            ...
                            <div className="right_bar_top d-flex align-items-center">
                                <div className="dropdown dropdown-user">
                                  <a href="javascript:;" className="dropdown-toggle">
                                   <img className="img-circle pro_pic" src={default_user} alt="" /> </a>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default MainTestPageHeader;